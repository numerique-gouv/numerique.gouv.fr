...
* **[une formation à la recherche utilisateur](https://design.numerique.gouv.fr/formations/recherche-utilisateur/)** le 9 décembre (ci-dessous)
* **[une formation à l'écoconception](https://design.numerique.gouv.fr/formations/ecoconception/)** le 16 décembre

> {: .text-center}
>
> #### Le jeudi 9 décembre de 10h à 12h, venez participer à une matinée d’échanges en visio sur la chaîne YouTube de DesignGouv !
>
...
> {: .text-center}
>
> ### 3 autres formations à ne pas manquer : accessibilité, design et écoconception
>
>N'oubliez pas qu'en plus de la formation à la recherche utilisateur, trois autres vous sont aussi proposées : [la formation accessibilité](https://design.numerique.gouv.fr/formations/accessibilite/), [la formation design](https://design.numerique.gouv.fr/formations/design/) et [la formation écoconception](https://design.numerique.gouv.fr/formations/ecoconception/)  (formulaires distincts). Elles auront également lieu en direct sur [la chaîne YouTube de DesignGouv](https://www.youtube.com/channel/UCMH9lC8dSlRVRfb0LoKuJZw/featured), et en différé.
>
