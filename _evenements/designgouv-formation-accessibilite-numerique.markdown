...
Pour que les administrations se posent les bonnes questions et prennent les bonnes décisions en utilisant les bonnes méthodes et les bons outils, le pôle **Design des services numériques** de la Direction interministérielle du numérique (DINUM) propose **trois formations gratuites indispensables : **une formation à l'accessibilité** le 18 novembre (ci-dessous), une formation au design le XX novembre, et une formation à la recherche utilisateur le XX décembre.**
