...
<br>
<p>Le Café Transfo est un événement organisé par <a href="https://www.numerique.gouv.fr/services/conseil-strategie-transformation-numerique/"> la mission Transformation numérique de l'État</a> ayant pour objectifs de tirer tout le potentiel du numérique – dans toutes ses composantes– pour transformer les politiques publiques. Cet événement est destiné à l’ensemble des décideurs publics qui se sentent concernés par les grands enjeux du numérique. Il se veut être une place de partage collaboratif de bonnes pratiques par et pour les administrations.</p>