...
Atelier | DONNÉES ET TERRITOIRES
*Animé par Benjamin DOBERSET, membre de la communauté [Beta.gouv.fr](https://beta.gouv.fr/)*
...
Masterclass | COMMUNS ET SOUVERAINETÉ

**17h-17h45 :** Comment les données peuvent être mises au service d’un accompagnement des usagers, en insertion ?
Retex | DONNÉES ET TERRITOIRES
*Avec Claire CASUBOLO, chargée de partenariats pour [data.insertion](https://www.rdv-insertion.fr/) et Amaury DUBOT, chargé de déploiement pour [beta.gouv.fr](https://beta.gouv.fr/).*
...
Atelier | MÉDIATION ET COMPÉTENCES NUMÉRIQUES
*Animé par Hugo STEPHAN, designer de services publics pour [Réfugiés.info](https://refugies.info/fr) et Daniel AGACINSKI, délégué général à la médiation, directeur de l’action territoriale pour le [Défenseur des droits](https://www.defenseurdesdroits.fr/).*
