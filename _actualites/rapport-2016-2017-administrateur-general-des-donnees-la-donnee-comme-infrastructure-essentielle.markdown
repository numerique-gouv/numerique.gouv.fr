...
<p class="text-center"><br> <br> <a href="/uploads/RapportAGD_2016-2017_web" title="Consulter le rapport « La donnée comme infrastructure essentielle » (pdf, 1,3 Mo)"><img src="/uploads/couv-rapport-agd-20162017-9e0add.png" alt="Consulter le rapport « La donnée comme infrastructure essentielle » (pdf, 1,3 Mo)" style="width: 25%; border:1px solid gray" ></a></p>
