...
Ce nouvel outil vient enrichir le sac à dos numérique de l’agent public (SNAP), qui compte déjà plusieurs outils de travail collaboratif : Webinaire de l’État, Webconf, Audioconf, la messagerie instantanée Tchap, les plateformes collaboratives Osmose et Resana.
