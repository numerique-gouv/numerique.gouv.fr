...
De même, les ministères démontrent une ambition importante dans le développement de hubs sectoriels de données (Health Data Hub, AgDataHub, Labor Data Hub, Education Data hub, etc.) permettant d’assurer la bonne circulation de données en accès restreint à un ensemble d’acteurs dûment habilités dans le cadre de leur mission. La DINUM animera un groupe de travail dédié au sein du réseau des administrateurs ministériels de données, et qui viendra nourrir une doctrine interministérielle en la matière.
...
Le ministère de la Transformation et de la Fonction publiques prend de son côté des engagements ambitieux en interministériel. Il charge notamment la DINUM, déjà mobilisée à leur côté sur le sujet, de poursuivre l’accompagnement des ministères dans la mise en œuvre de ces actions e, matière d’algorithmes. 
...
Les missions Label et Talents de la DINUM contribueront également sur ces deux derniers volets.
Les codes sources publiés par l'administration seront systématiquement référencés et présentés sur une future plateforme, code.gouv.fr. 
Le socle interministériel de logiciels libres et le catalogue GouvTech aideront l'administration à faire le choix raisonné d'utiliser des logiciels libres, en l'aidant à identifier des solutions et à en mesurer la pertinence.
...
Les délais nécessaires à l’obtention de moyens supplémentaires en support de ces stratégies sont également identifiés par plusieurs ministères comme un argument en faveur d’une révision de ces feuilles de route en 2022. 

Les ministères peuvent d’ores et déjà s’appuyer sur les différents dispositifs de financement proposés par l’Etat, à commencer par le plan France Relance, opéré par la DINUM pour le compte du ministère de la Transformation et de la Fonction publiques. 
...
Des acteurs de la recherche seront associés à sa mise en œuvre, et celle-ci sera évaluée au bout d’un an et révisée, le cas échéant, afin de prendre en compte les constats établis ou les textes susceptibles d’en impacter le cadre (notamment le Data Governance Act européen). 
Cette Charte est consultable sur le site numerique.gouv.fr (rubrique Publications – à confirmer).
