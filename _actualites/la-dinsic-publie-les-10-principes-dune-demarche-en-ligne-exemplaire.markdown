...
#### **Un premier jalon posé** **vers** l’**homologation Cerfa des démarches en ligne**

La voie est tracée. Les 10 règles d’or d’une démarche en ligne exemplaire intègreront prochainement la charte Internet de l’Etat, actuellement en cours de refonte. Surtout, elles sont les prémices d’une démarche structurante pour la qualité des services publics en ligne de l’Etat. A partir de l’automne 2017 sera progressivement mis en place le pendant numérique du Cerfa papier, bien connu des usagers. Toute démarche en ligne sera ainsi homologuée au travers de critères objectifs, vérifiables et réalistes, construits dans la logique de ces principes. Différents outils, comme les ressources et la checklist [Pidila](http://pidila.gitlab.io/), sont d’ores et déjà à la disposition des administrations pour les aider à concevoir des sites web dans les règles de l’art.