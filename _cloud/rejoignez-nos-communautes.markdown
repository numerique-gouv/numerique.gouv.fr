...
<div class="encadre noir" style="margin-bottom:40px"><h4>Comment rejoindre la communauté&nbsp;?</h4> <ul> <li><strong>Vous disposez déjà d’un compte sur la plateforme Osmose&nbsp;?</strong> Connectez-vous, en suivant <a href="https://osmose.numerique.gouv.fr/plugins/DINUMThemePlugin/jsp/front/privateLoginOsmose.jsp?redirect=https%3A%2F%2Fosmose.numerique.gouv.fr%2Fjcms%2Fp_3503877%2Ffr%2Fl-adoption-du-cloud" title="ce lien">ce lien</a> puis en cliquant sur le bouton « Je m’inscris ».</p></li> <li><strong>Vous ne disposez pas de compte Osmose&nbsp;?</strong> Contactez <a href="mailto:infonuage.dinum@modernisation.gouv.fr">infonuage.dinum@modernisation.gouv.fr</a> pour demander la création de votre compte.</li> </ul></div>
